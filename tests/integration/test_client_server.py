...
@pytest.fixture
def service(test_server: str) -> Any:
...
class TestEndToEndBackends:
    ...
    def test_list_backends(self, service: Any) -> None:
    ...
    def test_get_backend_info(self, service: Any) -> None:
...
class TestEndToEndSampler:
    ...
    def test_simple_bell_circuit(self, service: Any) -> None:
    ...
    def test_multiple_circuits(self, service: Any) -> None:
...
class TestEndToEndJobLifecycle:
    ...
    def test_job_status_progression(self, service: Any) -> None:
...
class TestEndToEndErrorHandling:
    ...
    def test_invalid_backend(self, service: Any) -> None:
    ...
    def test_backend_without_executor(self, service: Any) -> None:
